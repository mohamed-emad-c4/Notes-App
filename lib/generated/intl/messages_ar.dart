...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "AddedToArchive": MessageLookupByLibrary.simpleMessage(
      "تمت الإضافة إلى الأرشيف",
    ),
    "AddedToDeleted": MessageLookupByLibrary.simpleMessage(
      "تمت الإضافة إلى المحذوفات",
    ),
    ...
    "ArchivedNotes": MessageLookupByLibrary.simpleMessage("الملاحظات المؤرشفة"),
    ...
    "DeletedFromArchive": MessageLookupByLibrary.simpleMessage(
      "تم الحذف من الأرشيف",
    ),
    "DeletedNotes": MessageLookupByLibrary.simpleMessage("الملاحظات المحذوفة"),
    ...
    "FavoriteNotes": MessageLookupByLibrary.simpleMessage("الملاحظات المفضلة"),
    ...
    "HiddenNotes": MessageLookupByLibrary.simpleMessage("الملاحظات المخفية 🤫"),
    ...
    "NoFavoriteNotesAvailable": MessageLookupByLibrary.simpleMessage(
      "لا توجد ملاحظات مفضلة متاحة",
    ),
